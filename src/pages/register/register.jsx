  ...
  return (
    <main style={{ minHeight: '100vh', backgroundColor: '#fffde7', padding: '100px 20px', display: 'flex', justifyContent: 'center', alignItems: 'flex-start' }}>
      <div style={{ background: 'white', padding: '40px', borderRadius: '16px', border: '1px solid #e5e7eb', boxShadow: '0 10px 25px rgba(0,0,0,0.05)', width: '100%', maxWidth: '400px', marginTop: '40px' }}>
        ...
        <h2 style={{ color: '#1e3a8a', fontSize: '32px', marginBottom: '10px', textAlign: 'center' }}>Create Account</h2>
        <p style={{ color: '#555', textAlign: 'center', marginBottom: '30px' }}>Join LearnBuddy today!</p>
        
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          <input type="text" placeholder="Full Name" style={{ padding: '12px 15px', borderRadius: '8px', border: '1px solid #ccc', fontSize: '16px' }} />
          <input type="email" placeholder="Email Address" style={{ padding: '12px 15px', borderRadius: '8px', border: '1px solid #ccc', fontSize: '16px' }} />
          <input type="password" placeholder="Create Password" style={{ padding: '12px 15px', borderRadius: '8px', border: '1px solid #ccc', fontSize: '16px' }} />
